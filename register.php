      ...
      <form method="post" action="controls/insert-student.php">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" placeholder="กรุณากรอก Line ID" name="s_line" required>
        ...
        <div class="row mt-3">
          <div class="col-md-3">
            ...
            <input type="text" class="form-control" placeholder="กรุณากรอกบ้านเลขที่" name="s_address" required>
        ...
        <div class="row mt-3">
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" placeholder="กรุณากรอกอำเภอ" name="s_amphoe" required>
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" placeholder="กรุณากรอกรหัสไปรษณีย์" name="s_post" required>
